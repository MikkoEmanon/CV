...
const translations = {
  en: {
    ...
    skills: "Skills",
    contact: "Contact",
    name: "Mikko Fidias, PhD",
    tagline: "TECHNOLINGUIST:<br>LANGUAGE • TECH • EDUCATION",
...
Besides linguistics, I have knowledge of programming for digital humanities and NLP, music theory, project management, and indie game development. I follow the <i>tri-dharma</i> principle, developing myself, my discipline, and my institution, students and the local community. Future projects focus on developing digital tools for endangered languages, research in L2 education, and promoting academic leadership.`,
    ...
    theses_supervised: "Supervised multiple BA and MA Theses.",
    ...
    project_words_road: "— gamified vocabulary trainer (Android app)",
    ...
    cert_r: "Statistics for linguistics – R",
    cert_speech: "Speech pathology",
    cert_trans_pm: "Translation Project Management",
    cert_tesol: "English language teaching licence",
    cert_driving: "Driving licence",
    conf_title: "Conferences (attendance, selected)",
    conf_networking: "Academic Networking and Collaboration",
    conf_degruyter: "De Gruyter Brill (webinar)",
    conf_ec: "European Commission",
    conf_roma_title: "New Challenges in Dictionary Teaching",
    conf_roma_uni: "Roma Tre University",
    conf_memorial: "The Pandemic, Technology, and Language Revitalization, Memorial University",
    conf_wiko: "Minority Languages in the Digital Age",
    ...
    becas: "Scholarships: Erasmus LLP; University of the Basque Country; Erasmus Mundus",
  ...
  es: {
    ...
    contact: "Contacto",
    name: "Mikko Fidias, PhD",
    tagline: "TECNOLINGÜÍSTA:<br>IDIOMA • TECNOLOGÍA • EDUCACIÓN",
...
Además de la lingüística, tengo conocimientos de programación para humanidades digitales y PLN, teoría musical, gestión de proyectos, y desarrollo de videojuegos indie. Sigo el principio <i>tri-dharma</i>, desarrollándome a mí mismo, a mi ciencia, y a mi institución, alumnos y la comunidad local. Mis proyectos futuros se centran en el desarrollo de herramientas digitales para lenguas amenazadas, investigación en enseñanza de L2 y promoción del liderazgo académico.`,
    ...
    remote: "remoto",
    miu_dates: "septiembre 2024–presente",
    ...
    theses_supervised: "He supervisado múltiples TFGs y TFMs.",
    ...
    project_words_road: "— entrenador de vocabulario gamificado (aplicación Android)",
    ...
    cert_r: "Estadística para lingüística – R",
    cert_speech: "Patología del lenguaje",
    cert_trans_pm: "Gestión de proyectos de traducción",
    cert_tesol: "Certificado de enseñanza de inglés",
    cert_driving: "Carnet de conducir",
    conf_title: "Conferencias (asistencia, selección)",
    conf_networking: "Networking académico y colaboración",
    conf_degruyter: "De Gruyter Brill (webinar)",
    conf_ec: "Comisión Europea",
    conf_roma_title: "New Challenges in Dictionary Teaching",
    conf_roma_uni: "Universidad Roma Tre",
    conf_memorial: "The Pandemic, Technology, and Language Revitalization, Memorial University",
    conf_wiko: "Minority Languages in the Digital Age",
    ...
    becas: "Becas: Erasmus LLP; University of the Basque Country; Erasmus Mundus",
